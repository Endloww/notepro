    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('category', EntityType::class, [
                'class' => Category::class, // Assurez-vous d'utiliser la bonne classe pour la catégorie.
                'label' => 'Catégorie',
                'choice_label' => 'name', // Utilisez l'attribut qui représente le nom de la catégorie.
                'expanded' => false,
                'multiple' => false,
            ]);
        ;
